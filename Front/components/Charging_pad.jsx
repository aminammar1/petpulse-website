...
import styles from '../Styles/Charging_pad.module.css';
...
const Tracker = () => {
  ...
  const trackerProduct = products.find(product => product.slug === 'charging_pad');
    ...
    >
      ★
          ...
          <p className={styles.additional_text}>
                Charging pad and USB cable for PetPulse Dog GPS Tracker.<br/>

                Compatible with Qi-enabled devices, including PetPulse<br/> GPS, many modern smartphones and other wireless <br/>devices.<br/>

                Perfect as a spare or replacement charging pad.<br/>

                PetPulse Dog GPS Tracker not included.
          </p>
          ...
          <button className={styles.button} onClick={() => addToCart('Charging pad', quantity)}>Add to Cart</button>
