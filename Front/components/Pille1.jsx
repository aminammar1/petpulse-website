...
const Tracker = () => {
  ...
  const trackerProduct = products.find(product => product.slug === 'pille1');
  ...
  {[...Array(5)].map((_, index) => (
    ...
    >
      ★
          ...
          Panasonic CR2032 lithium battery suitable for PetPulse 2.<br/>
          ...
          <button className={styles.button} onClick={() => addToCart('CR2032 battery', quantity)}>Add to Cart</button>
